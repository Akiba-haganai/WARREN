    ...
    <AppShell>
      <div className="px-4 pb-8 max-w-lg mx-auto">
        ...
        <div className="prose prose-sm dark:prose-invert space-y-4">
          ...
          <p>
            Campus ("we", "our", "us") is committed to protecting your privacy.
            This Privacy Policy explains how your personal information is collected,
            used, and disclosed by Campus.
          </p>
          ...
          <p>
            Campus uses Google AdSense to display advertisements. AdSense may use
