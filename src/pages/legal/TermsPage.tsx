    ...
    <AppShell>
      <div className="px-4 pb-8 max-w-lg mx-auto">
        ...
        <div className="prose prose-sm dark:prose-invert space-y-4">
          ...
          <p>
            By accessing or using Campus, you agree to be bound by these Terms
          ...
          <p>
            All content and materials available on Campus are protected by
            applicable intellectual property laws. You may not reproduce,
            distribute, or create derivative works without permission.
          </p>
          <h3>Termination</h3>
          <p>
            We may suspend or terminate your access to Campus at any time,
