...
export default function HomePage() {
  ...
  // Fetch current user's profile for the composer prompt
  ...
  const handleScroll = (e: React.UIEvent<HTMLDivElement>) => {
    ...
    setShowFab(currentY < lastScrollY.current || currentY < 20);
  ...
  return (
    <>
      <AppShell>
        ...
        >
          {/* Sticky header – no more guidelines banner */}
          ...
          <Feed
            ...
            onOpenComposer={() => setOpenSheet(true)}
      ...
      <CreatePostSheet
        ...
        onCreated={() => { setOpenSheet(false); refetch(); }}
      />

      {activeCommentPostId && (
        <div
          className="fixed inset-0 z-50 flex items-end justify-center bg-black/50 backdrop-blur-sm"
          onClick={() => { setActiveCommentPostId(null); setActiveCommentPostOwner(null); }}
        >
          <div
          ...
          >
            {/* Mini post preview in the sheet header */}
            {activePost && (
            ...
            <div className="flex-1 overflow-y-auto">
              <CommentSection
                ...
                onClose={() => { setActiveCommentPostId(null); setActiveCommentPostOwner(null); }}
              />
            </div>
          </div>
        </div>
